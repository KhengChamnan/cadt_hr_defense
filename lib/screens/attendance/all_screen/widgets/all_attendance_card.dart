...
/// All Attendance Card Widget
/// - Displays attendance information in a list format
/// - Follows the same design pattern as WeeklyAttendanceCard
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  // Just date in header (no day of week needed)
                  Text(
                    date ?? '',
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: Colors.white,
                // Add bottom border for separation between items
                border: Border(
                  bottom: BorderSide(
